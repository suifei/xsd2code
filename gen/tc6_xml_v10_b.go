...
// Generated on 2025-06-03 16:50:36
...
type DataType struct {
	...
	BYTE uint8 `xml:"BYTE,omitempty" json:"BYTE,omitempty"`
	WORD uint16 `xml:"WORD,omitempty" json:"WORD,omitempty"`
	DWORD uint32 `xml:"DWORD,omitempty" json:"DWORD,omitempty"`
	LWORD uint64 `xml:"LWORD,omitempty" json:"LWORD,omitempty"`
	SINT int8 `xml:"SINT,omitempty" json:"SINT,omitempty"`
	INT int16 `xml:"INT,omitempty" json:"INT,omitempty"`
	DINT int32 `xml:"DINT,omitempty" json:"DINT,omitempty"`
	LINT int64 `xml:"LINT,omitempty" json:"LINT,omitempty"`
	USINT uint8 `xml:"USINT,omitempty" json:"USINT,omitempty"`
	UINT uint16 `xml:"UINT,omitempty" json:"UINT,omitempty"`
	UDINT uint32 `xml:"UDINT,omitempty" json:"UDINT,omitempty"`
	ULINT uint64 `xml:"ULINT,omitempty" json:"ULINT,omitempty"`
	REAL float32 `xml:"REAL,omitempty" json:"REAL,omitempty"`
	LREAL float64 `xml:"LREAL,omitempty" json:"LREAL,omitempty"`
	TIME *time.Duration `xml:"TIME,omitempty" json:"TIME,omitempty"`
	DATE *time.Time `xml:"DATE,omitempty" json:"DATE,omitempty"`
	DT *time.Time `xml:"DT,omitempty" json:"DT,omitempty"`
	TOD *time.Time `xml:"TOD,omitempty" json:"TOD,omitempty"`
...
type BodyFBDComment struct {
	...
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
...
type BodyFBDActionBlockAction struct {
	...
	Inline *Body `xml:"inline,omitempty" json:"inline,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
...
type BodyFBDActionBlock struct {
	...
	ConnectionPointIn *ConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut *ConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Action []BodyFBDActionBlockAction `xml:"action,omitempty" json:"action,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodyFBDBlockInputVariables struct {
	...
	Variable []BodyFBDBlockInputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyFBDBlockInOutVariables struct {
	...
	Variable []BodyFBDBlockInOutVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyFBDBlockOutputVariables struct {
	...
	Variable []BodyFBDBlockOutputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyFBD struct {
	...
	Comment *BodyFBDComment `xml:"comment,omitempty" json:"comment,omitempty"`
	Error *BodyFBDError `xml:"error,omitempty" json:"error,omitempty"`
	Connector *BodyFBDConnector `xml:"connector,omitempty" json:"connector,omitempty"`
	// Counterpart of the connector element
	Continuation *BodyFBDContinuation `xml:"continuation,omitempty" json:"continuation,omitempty"`
	ActionBlock *BodyFBDActionBlock `xml:"actionBlock,omitempty" json:"actionBlock,omitempty"`
	Block *BodyFBDBlock `xml:"block,omitempty" json:"block,omitempty"`
	// Expression used as producer
	InVariable *BodyFBDInVariable `xml:"inVariable,omitempty" json:"inVariable,omitempty"`
	// Expression used as consumer
	OutVariable *BodyFBDOutVariable `xml:"outVariable,omitempty" json:"outVariable,omitempty"`
	// Expression used as producer and consumer
	InOutVariable *BodyFBDInOutVariable `xml:"inOutVariable,omitempty" json:"inOutVariable,omitempty"`
	Label *BodyFBDLabel `xml:"label,omitempty" json:"label,omitempty"`
	Jump *BodyFBDJump `xml:"jump,omitempty" json:"jump,omitempty"`
	Return *BodyFBDReturn `xml:"return,omitempty" json:"return,omitempty"`
}
...
type BodyLDActionBlockAction struct {
	XMLName xml.Name `xml:"action" json:"-"`
	// Name of an action or boolean variable.
	Reference *BodyLDActionBlockActionReference `xml:"reference,omitempty" json:"reference,omitempty"`
	// Inline implementation of an action body.
	Inline *Body `xml:"inline,omitempty" json:"inline,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	Qualifier *string `xml:"qualifier,attr" json:"qualifier,omitempty"`
...
type BodyLDActionBlock struct {
	...
	ConnectionPointIn *ConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut *ConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Action []BodyLDActionBlockAction `xml:"action,omitempty" json:"action,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodyLDBlockInputVariables struct {
	XMLName xml.Name `xml:"inputVariables" json:"-"`
	Variable []BodyLDBlockInputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyLDBlockInOutVariables struct {
	XMLName xml.Name `xml:"inOutVariables" json:"-"`
	Variable []BodyLDBlockInOutVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyLDBlockOutputVariables struct {
	XMLName xml.Name `xml:"outputVariables" json:"-"`
	Variable []BodyLDBlockOutputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodyLDLeftPowerRail struct {
	...
	Position Position `xml:"position" json:"position"`
	ConnectionPointOut []BodyLDLeftPowerRailConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodyLD struct {
	...
	Comment *BodyLDComment `xml:"comment,omitempty" json:"comment,omitempty"`
	Error *BodyLDError `xml:"error,omitempty" json:"error,omitempty"`
	Connector *BodyLDConnector `xml:"connector,omitempty" json:"connector,omitempty"`
	// Counterpart of the connector element
	Continuation *BodyLDContinuation `xml:"continuation,omitempty" json:"continuation,omitempty"`
	ActionBlock *BodyLDActionBlock `xml:"actionBlock,omitempty" json:"actionBlock,omitempty"`
	Block *BodyLDBlock `xml:"block,omitempty" json:"block,omitempty"`
	// Expression used as producer
	InVariable *BodyLDInVariable `xml:"inVariable,omitempty" json:"inVariable,omitempty"`
	// Expression used as consumer
	OutVariable *BodyLDOutVariable `xml:"outVariable,omitempty" json:"outVariable,omitempty"`
	// Expression used as producer and consumer
	InOutVariable *BodyLDInOutVariable `xml:"inOutVariable,omitempty" json:"inOutVariable,omitempty"`
	Label *BodyLDLabel `xml:"label,omitempty" json:"label,omitempty"`
	Jump *BodyLDJump `xml:"jump,omitempty" json:"jump,omitempty"`
	Return *BodyLDReturn `xml:"return,omitempty" json:"return,omitempty"`
	LeftPowerRail *BodyLDLeftPowerRail `xml:"leftPowerRail,omitempty" json:"leftPowerRail,omitempty"`
	RightPowerRail *BodyLDRightPowerRail `xml:"rightPowerRail,omitempty" json:"rightPowerRail,omitempty"`
	Coil *BodyLDCoil `xml:"coil,omitempty" json:"coil,omitempty"`
	Contact *BodyLDContact `xml:"contact,omitempty" json:"contact,omitempty"`
}
...
type BodySFCActionBlockAction struct {
	XMLName xml.Name `xml:"action" json:"-"`
	// Name of an action or boolean variable.
	Reference *BodySFCActionBlockActionReference `xml:"reference,omitempty" json:"reference,omitempty"`
	// Inline implementation of an action body.
	Inline *Body `xml:"inline,omitempty" json:"inline,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	Qualifier *string `xml:"qualifier,attr" json:"qualifier,omitempty"`
...
type BodySFCActionBlock struct {
	...
	ConnectionPointIn *ConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut *ConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Action []BodySFCActionBlockAction `xml:"action,omitempty" json:"action,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodySFCBlockInputVariables struct {
	XMLName xml.Name `xml:"inputVariables" json:"-"`
	Variable []BodySFCBlockInputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodySFCBlockInOutVariables struct {
	XMLName xml.Name `xml:"inOutVariables" json:"-"`
	Variable []BodySFCBlockInOutVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodySFCBlockOutputVariables struct {
	XMLName xml.Name `xml:"outputVariables" json:"-"`
	Variable []BodySFCBlockOutputVariablesVariable `xml:"variable,omitempty" json:"variable,omitempty"`
}
...
type BodySFCLeftPowerRail struct {
	XMLName xml.Name `xml:"leftPowerRail" json:"-"`
	Position Position `xml:"position" json:"position"`
	ConnectionPointOut []BodySFCLeftPowerRailConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodySFCSelectionDivergence struct {
	...
	Position Position `xml:"position" json:"position"`
	ConnectionPointIn *ConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut []BodySFCSelectionDivergenceConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodySFCSelectionConvergence struct {
	...
	Position Position `xml:"position" json:"position"`
	ConnectionPointIn []BodySFCSelectionConvergenceConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut *ConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
...
type BodySFCSimultaneousDivergence struct {
	...
	Position Position `xml:"position" json:"position"`
	ConnectionPointIn *ConnectionPointIn `xml:"connectionPointIn,omitempty" json:"connectionPointIn,omitempty"`
	ConnectionPointOut []BodySFCSimultaneousDivergenceConnectionPointOut `xml:"connectionPointOut,omitempty" json:"connectionPointOut,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalId uint64 `xml:"localId,attr" json:"localId"`
	Height *float64 `xml:"height,attr" json:"height,omitempty"`
	Width *float64 `xml:"width,attr" json:"width,omitempty"`
...
type BodySFC struct {
	...
	Comment *BodySFCComment `xml:"comment,omitempty" json:"comment,omitempty"`
	Error *BodySFCError `xml:"error,omitempty" json:"error,omitempty"`
	Connector *BodySFCConnector `xml:"connector,omitempty" json:"connector,omitempty"`
	// Counterpart of the connector element
	Continuation *BodySFCContinuation `xml:"continuation,omitempty" json:"continuation,omitempty"`
	ActionBlock *BodySFCActionBlock `xml:"actionBlock,omitempty" json:"actionBlock,omitempty"`
	Block *BodySFCBlock `xml:"block,omitempty" json:"block,omitempty"`
	// Expression used as producer
	InVariable *BodySFCInVariable `xml:"inVariable,omitempty" json:"inVariable,omitempty"`
	// Expression used as consumer
	OutVariable *BodySFCOutVariable `xml:"outVariable,omitempty" json:"outVariable,omitempty"`
	// Expression used as producer and consumer
	InOutVariable *BodySFCInOutVariable `xml:"inOutVariable,omitempty" json:"inOutVariable,omitempty"`
	Label *BodySFCLabel `xml:"label,omitempty" json:"label,omitempty"`
	Jump *BodySFCJump `xml:"jump,omitempty" json:"jump,omitempty"`
	Return *BodySFCReturn `xml:"return,omitempty" json:"return,omitempty"`
	LeftPowerRail *BodySFCLeftPowerRail `xml:"leftPowerRail,omitempty" json:"leftPowerRail,omitempty"`
	RightPowerRail *BodySFCRightPowerRail `xml:"rightPowerRail,omitempty" json:"rightPowerRail,omitempty"`
	Coil *BodySFCCoil `xml:"coil,omitempty" json:"coil,omitempty"`
	Contact *BodySFCContact `xml:"contact,omitempty" json:"contact,omitempty"`
	...
	Step *BodySFCStep `xml:"step,omitempty" json:"step,omitempty"`
	MacroStep *BodySFCMacroStep `xml:"macroStep,omitempty" json:"macroStep,omitempty"`
	// Jump to a step, macro step or simultaneous divergence. Acts like a step.
	// Predecessor should be a transition.
	JumpStep *BodySFCJumpStep `xml:"jumpStep,omitempty" json:"jumpStep,omitempty"`
	Transition *BodySFCTransition `xml:"transition,omitempty" json:"transition,omitempty"`
	SelectionDivergence *BodySFCSelectionDivergence `xml:"selectionDivergence,omitempty" json:"selectionDivergence,omitempty"`
	SelectionConvergence *BodySFCSelectionConvergence `xml:"selectionConvergence,omitempty" json:"selectionConvergence,omitempty"`
	SimultaneousDivergence *BodySFCSimultaneousDivergence `xml:"simultaneousDivergence,omitempty" json:"simultaneousDivergence,omitempty"`
	SimultaneousConvergence *BodySFCSimultaneousConvergence `xml:"simultaneousConvergence,omitempty" json:"simultaneousConvergence,omitempty"`
}
...
type Body struct {
	...
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	IL *FormattedText `xml:"IL,omitempty" json:"IL,omitempty"`
	ST *FormattedText `xml:"ST,omitempty" json:"ST,omitempty"`
...
type VarListPlain struct {
	...
	Variable []VarListPlainVariable `xml:"variable,omitempty" json:"variable,omitempty"`
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
}
...
type ConnectionPointIn struct {
	...
	// the block.
	RelPosition *Position `xml:"relPosition,omitempty" json:"relPosition,omitempty"`
	Connection []Connection `xml:"connection,omitempty" json:"connection,omitempty"`
...
type ProjectTypesDataTypes struct {
	...
	DataType []ProjectTypesDataTypesDataType `xml:"dataType,omitempty" json:"dataType,omitempty"`
}
...
type ProjectTypesPousPouInterface struct {
	...
	// Additional userspecific information to the element
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	LocalVars *ProjectTypesPousPouInterfaceLocalVars `xml:"localVars,omitempty" json:"localVars,omitempty"`
	TempVars *ProjectTypesPousPouInterfaceTempVars `xml:"tempVars,omitempty" json:"tempVars,omitempty"`
	InputVars *ProjectTypesPousPouInterfaceInputVars `xml:"inputVars,omitempty" json:"inputVars,omitempty"`
	OutputVars *ProjectTypesPousPouInterfaceOutputVars `xml:"outputVars,omitempty" json:"outputVars,omitempty"`
	InOutVars *ProjectTypesPousPouInterfaceInOutVars `xml:"inOutVars,omitempty" json:"inOutVars,omitempty"`
	ExternalVars *ProjectTypesPousPouInterfaceExternalVars `xml:"externalVars,omitempty" json:"externalVars,omitempty"`
	GlobalVars *ProjectTypesPousPouInterfaceGlobalVars `xml:"globalVars,omitempty" json:"globalVars,omitempty"`
...
type ProjectTypesPousPouActions struct {
	...
	Action []ProjectTypesPousPouActionsAction `xml:"action,omitempty" json:"action,omitempty"`
}
...
type ProjectTypesPousPouTransitions struct {
	...
	Transition []ProjectTypesPousPouTransitionsTransition `xml:"transition,omitempty" json:"transition,omitempty"`
}
...
type ProjectTypesPousPou struct {
	...
	Interface *ProjectTypesPousPouInterface `xml:"interface,omitempty" json:"interface,omitempty"`
	Actions *ProjectTypesPousPouActions `xml:"actions,omitempty" json:"actions,omitempty"`
	Transitions *ProjectTypesPousPouTransitions `xml:"transitions,omitempty" json:"transitions,omitempty"`
	Body *Body `xml:"body,omitempty" json:"body,omitempty"`
	// Additional userspecific information to the element
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	Name string `xml:"name,attr" json:"name"`
...
type ProjectTypesPous struct {
	...
	Pou []ProjectTypesPousPou `xml:"pou,omitempty" json:"pou,omitempty"`
}
...
type ProjectInstancesConfigurationsConfigurationResourceTask struct {
	...
	PouInstance []PouInstance `xml:"pouInstance,omitempty" json:"pouInstance,omitempty"`
	// Additional userspecific information to the element
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	Name string `xml:"name,attr" json:"name"`
...
type ProjectInstancesConfigurationsConfigurationResource struct {
	...
	Task []ProjectInstancesConfigurationsConfigurationResourceTask `xml:"task,omitempty" json:"task,omitempty"`
...
type ProjectInstancesConfigurationsConfiguration struct {
	...
	Resource []ProjectInstancesConfigurationsConfigurationResource `xml:"resource,omitempty" json:"resource,omitempty"`
	GlobalVars []VarList `xml:"globalVars,omitempty" json:"globalVars,omitempty"`
	// Additional userspecific information to the element
	Documentation *FormattedText `xml:"documentation,omitempty" json:"documentation,omitempty"`
	Name string `xml:"name,attr" json:"name"`
...
type ProjectInstancesConfigurations struct {
	...
	Configuration []ProjectInstancesConfigurationsConfiguration `xml:"configuration,omitempty" json:"configuration,omitempty"`
}
